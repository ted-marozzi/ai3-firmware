 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 409.00 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + PADDING //for brushing
#define Y_MAX_POS Y_BED_SIZE + PADDING
...
#define HOMING_FEEDRATE_Z  (5*60) //used to be 5
